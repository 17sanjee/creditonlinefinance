...
const Testimonials = () => {
  ...
  return (
    ...
    >
      <h2 className="text-center text-2xl font-bold underline-blue mb-8">WHAT CLIENTS SAY ABOUT US</h2>
      <p className="text-center text-lg mb-12">What our customers are saying about us!</p>
